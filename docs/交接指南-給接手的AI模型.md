...
### ⚡ 2026-07-19 UIUX 現況（接手 UI／前台前必讀）

1. **`docs/UIUX本輪改動同步-2026-07-19.md`** — 本輪 commits、BX2–10、SYN-1 UI、T112-r3、檔案表、**勿重做清單**
2. `docs/UIUX指揮交接-下一任接續.md` — 短交接
3. `docs/UIUX總指揮計劃包-2026-07-18.md` — 狀態頭＋§9
4. `docs/施工清單.md` — 進度筆記最新幾則（BX1–10 已勾）

**現況摘要**：T74–T119 程式待 Claude 核畫面；BX1–10 已做；未 push。不要重做 BX2/6/7/9/10 或站②生成詳情圖開關。
