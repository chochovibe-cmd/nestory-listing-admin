...
// Item B — eliminate the historical unequal copy-review columns at the source,
// then lock final mobile geometry to three equal 40px controls.
...
console.log("D3.6 mobile select-all and copy-review batch geometry source contract passed");
