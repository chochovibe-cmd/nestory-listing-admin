...
- 差異：所有語氣共用「品牌 × IP中文＋英文 | 角色／系列／精準品項 | 有用的款式差異」。品牌有可靠英文名稱時優先英文，僅有中文時保留中文，沒有聯名或製造品牌時只呈現 IP。
- 原因：Owner 本輪明確要求品牌在 IP 前；取代歷史文件中的「IP × 品牌」。
- 拍板：Owner 2026-09-24 對話。午後三段標題實作已依 Owner 要求撤回，等 Codex 確認。現況預覽程式回到 `b6fc4d7`。既有草稿不批次改寫。UI 結構與樣式沿用現況。
