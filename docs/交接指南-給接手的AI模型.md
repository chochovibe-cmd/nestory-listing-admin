...
1. **`docs/UIUX本輪改動同步-2026-07-21.md`** — **本輪 B4**（老闆七項 → P01–P05 發包；程式待做）
2. `docs/UIUX本輪改動同步-2026-07-19.md` — B2／歷史 commits、勿重做清單
3. `docs/UIUX指揮交接-下一任接續.md` — 短交接
4. `docs/施工清單.md` — **UX-B4 勾選區**＋進度筆記
5. Mockup差異 **43／44**（自動展開、手機 chrome）— 待 B4 實作打勾

**現況摘要**：B3-P01～P06 已完成。B4 已發包未實作。建議序 P02→P01→P04→P03→P05。  
不要重做 B3 長按／左滑／規格 B 方案本體（B4 是疊加）。
