...
### 差異 51：潮巢導購寫手拆層（3–5 主軸＋其餘補潤；看圖可寫顏色材質）

- **差在哪**：
  1. 潮巢導購版版面維持商品介紹／收藏亮點／適合誰／商品資訊／購買提醒，不改回舊工具 A–E。
  2. 寫手核心與後端作業分開；寫手放 prompt 最後。3～5 個特色是主軸先後，其餘真實特色繼續寫。
  3. 看圖素材可寫具體顏色／材質觀察；搜尋改查造型與系列，不只尺寸材質。
- **為什麼**：Owner 2026-09-23——老闆要潮巢導購版；文案要像以前有創意有內容；3–5 不是上限。
- **誰拍板**：Owner 2026-09-23。
- **現況**：✅ 已實作並 commit `5966c33` 於 `agent/chaochao-tone-on-live`。CC-6 Preview 不含本包。尚未 push、尚未部署正式站。
...
- **誰拍板**：Owner 2026-09-23。
- **現況**：✅ 已實作於 `agent/chaochao-tone-on-live` 本機。尚未 push Preview、尚未部署正式站。
...
- 2026-09-23（本機）：差異 51 **潮巢導購寫手拆層**——3–5 主軸非上限；看圖可寫顏色材質；搜尋 `adv8feat1`。commit `5966c33`，未 push。
- 2026-09-23：差異 50 **潮巢導購 Owner 樣板＋短規則＋購買提醒**。Preview `14f27c4`／`2u2u3lg60`；語氣未過，由差異 51 接續。
