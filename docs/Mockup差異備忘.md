...
- **現況**：✅ 現役。Preview `14f27c4`／`2u2u3lg60`。CC-7 已撤回。尚未部署正式站。
...
## 2026-09-24｜商品標題品牌順序（Owner 定案）

- 差異：所有語氣共用「品牌 × IP中文＋英文 | 角色＋商品種類 | 造型或款式差異」。沒有聯名或製造品牌時只呈現 IP。第二段不放 Q版、萌粒、鍵帽這類造型詞；造型放到第三段。沒有造型差異才省略第三段。
- 品牌：名創優品、萬代、樂高用已確認的官方英文 MINISO、Bandai、LEGO，不再為這三個多打一次搜尋。其他品牌要在來源或既有搜尋摘錄看到可靠英文才用英文，查不到就留中文。不要把淘寶、天貓、蝦皮或店名當品牌，也不要猜英文。
- 驗收例句：`MINISO × 七龍珠 DRAGON BALL Z | 孫悟空 盲盒擺件 | Q版萌粒鍵帽`。
- 原因：Owner 要求品牌在 IP 前，並於 2026-09-24 午後指定三段分工與「查到英文就用英文」。
- 拍板：Owner 2026-09-24 對話。2026-09-24 午後已實作：第二段只留角色＋商品種類，造型撥到第三段。名創優品、萬代、樂高直接用官方英文；其他品牌只在來源或既有搜尋摘錄看到英文時才換。不另開搜尋、不加第二次模型呼叫。SEO 標題不要抄這三段。正文說明與成品分開。既有草稿不批次改寫。尚未 push。UI 結構與樣式沿用現況。
